...
export default function ProductAnalysis() {
  ...
  const salesData = useMemo(() => {
    const groupedAll = groupBismillahByField(bismillahData, 'produk_tanya');
    ...
    const groupedClosing = groupBismillahByField(closings, 'produk_tanya');
    ...
    }).sort((a,b) => b.Closing - a.Closing).slice(0, 20); // Limit to top 20 for products
  }, [bismillahData]);
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-gray-900">Product Analysis (Leads)</h2>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* ... (Charts remain same) ... */}
        <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
          <h3 className="font-semibold text-gray-800 mb-4">Leads vs Closing per Product</h3>
          <div className="h-72">
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
          <h3 className="font-semibold text-gray-800 mb-4">Conversion Rate per Product</h3>
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 lg:col-span-2">
          <h3 className="font-semibold text-gray-800 mb-4">Potential Omzet per Product</h3>
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 overflow-x-auto">
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-semibold text-gray-800">Detail per Product</h3>
          <button 
            onClick={() => exportToCSV(salesData, 'product_analysis.csv')}
