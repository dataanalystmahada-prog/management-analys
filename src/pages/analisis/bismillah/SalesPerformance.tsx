...
export default function SalesPerformance() {
  ...
  const salesData = useMemo(() => {
    const groupedAll = groupBismillahByField(bismillahData, 'pic');
    ...
    const groupedClosing = groupBismillahByField(closings, 'pic');
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-gray-900">Sales Performance (Leads)</h2>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* ... (Charts remain same) ... */}
        <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
          <h3 className="font-semibold text-gray-800 mb-4">Leads vs Closing per Sales</h3>
          <div className="h-72">
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200">
          <h3 className="font-semibold text-gray-800 mb-4">Conversion Rate per Sales</h3>
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 lg:col-span-2">
          <h3 className="font-semibold text-gray-800 mb-4">Potential Omzet per Sales</h3>
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-200 overflow-x-auto">
        <div className="flex justify-between items-center mb-4">
          ...
          <button 
            onClick={() => exportToCSV(salesData, 'sales_performance.csv')}
